...
<<<<<<< HEAD:signed_struct/src/lib.rs
/// implement the `pyrsia_node::Signed` trait that includes methods for signing the struct,
=======
/// implement the `pyrsia::Signed` trait that includes methods for signing the struct,
>>>>>>> 68de316 (playing with rust book ch 7):src/signed_struct/src/lib.rs
...
=======
                                impl #lifetime crate::signed::Signed #signed_lifetime for #struct_ident #lifetime {
>>>>>>> 68de316 (playing with rust book ch 7):src/signed_struct/src/lib.rs
