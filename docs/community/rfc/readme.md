...
["Architecture"](https://pyrsia.io/docs/community/get_involved/#attend-a-community-meeting) meeting, we schedule additional meetings as need. Actions are recorded in the meeting minutes.
