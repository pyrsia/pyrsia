...
```shell
msiexec /i Downloads/pyrsia-installer-0.2.1.msi ROOTDRIVE="C:"
```
...
pyrsia --version
```
Display the version `pyrsia_cli 0.2.1`
...
```sh
docker run -d -p 7888:7888 --name pyrsia_node pyrsiaoss/pyrsia-node:0.2.1-2562
```
...
services:
  pyrsia:
    image: pyrsiaoss/pyrsia-node:0.2.1-2562
    ports:
      - "7888:7888"
    volumes:
      - "pyrsia:/pyrsia"
